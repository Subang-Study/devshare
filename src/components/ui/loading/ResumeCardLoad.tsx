const ResumeCardLoad = () => {
  return (
    <div className="flex flex-col justify-around w-full gap-2 p-4 shadow-xl aspect-video rounded-xl bg-neutral-200 dark:bg-neutral-500 animate-pulse min-w-[300px]">
